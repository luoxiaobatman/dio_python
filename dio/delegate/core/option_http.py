...
class _Http_:
    path: str
    header: Optional[Dict[str, str]]  # TODOlx 用HttpHeader
...
# class ImmutableOptionHttp(_Http_, Immutable):
#     @property
#     def path(self):
...
#     def unfrozon(self) -> _Http_:
#         unfrozoned = _Http_()
#         unfrozoned.path = self.path
#         unfrozoned.timeout = self.timeout
#         unfrozoned.retry = self.retry
#         return unfrozoned
